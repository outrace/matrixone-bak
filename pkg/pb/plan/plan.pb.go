...
type Node struct {
	...
	InsertCtx            *InsertCtx    `protobuf:"bytes,28,opt,name=insert_ctx,json=insertCtx,proto3" json:"insert_ctx,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
type DeleteCtx struct {
	DelRef               []*ObjectRef       `protobuf:"bytes,1,rep,name=del_ref,json=delRef,proto3" json:"del_ref,omitempty"`
	DelIdxRef            []*ObjectRef       `protobuf:"bytes,2,rep,name=del_idx_ref,json=delIdxRef,proto3" json:"del_idx_ref,omitempty"`
	DelIdxIdx            []int32            `protobuf:"varint,3,rep,packed,name=del_idx_idx,json=delIdxIdx,proto3" json:"del_idx_idx,omitempty"`
	...
	OnSetAttrs           []*DeleteCtxAttrs  `protobuf:"bytes,9,rep,name=on_set_attrs,json=onSetAttrs,proto3" json:"on_set_attrs,omitempty"`
	OnSetIdx             []*DeleteCtxIdList `protobuf:"bytes,10,rep,name=on_set_idx,json=onSetIdx,proto3" json:"on_set_idx,omitempty"`
	CanTruncate          bool               `protobuf:"varint,11,opt,name=can_truncate,json=canTruncate,proto3" json:"can_truncate,omitempty"`
	ParentIds            []*DeleteCtxIdList `protobuf:"bytes,12,rep,name=parent_ids,json=parentIds,proto3" json:"parent_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *DeleteCtx) GetDelRef() []*ObjectRef {
	if m != nil {
		return m.DelRef
	}
	return nil
...
func (m *DeleteCtx) GetDelIdxRef() []*ObjectRef {
	if m != nil {
		return m.DelIdxRef
	}
	return nil
...
func (m *DeleteCtx) GetDelIdxIdx() []int32 {
	if m != nil {
		return m.DelIdxIdx
	}
	return nil
...
func (m *DeleteCtx) GetOnSetAttrs() []*DeleteCtxAttrs {
	if m != nil {
		return m.OnSetAttrs
	}
	return nil
...
func (m *DeleteCtx) GetOnSetIdx() []*DeleteCtxIdList {
	if m != nil {
		return m.OnSetIdx
	}
	return nil
...
func (m *DeleteCtx) GetParentIds() []*DeleteCtxIdList {
	if m != nil {
		return m.ParentIds
	}
	return nil
...
func (m *DeleteCtxIdList) Reset()         { *m = DeleteCtxIdList{} }
func (m *DeleteCtxIdList) String() string { return proto.CompactTextString(m) }
func (*DeleteCtxIdList) ProtoMessage()    {}
func (*DeleteCtxIdList) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{45, 0}
}
func (m *DeleteCtxIdList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DeleteCtxIdList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DeleteCtxIdList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DeleteCtxIdList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteCtxIdList.Merge(m, src)
}
func (m *DeleteCtxIdList) XXX_Size() int {
	return m.ProtoSize()
}
func (m *DeleteCtxIdList) XXX_DiscardUnknown() {
	xxx_messageInfo_DeleteCtxIdList.DiscardUnknown(m)
}

var xxx_messageInfo_DeleteCtxIdList proto.InternalMessageInfo

func (m *DeleteCtxIdList) GetList() []int64 {
	if m != nil {
		return m.List
	}
	return nil
...
func (m *DeleteCtxAttrs) Reset()         { *m = DeleteCtxAttrs{} }
func (m *DeleteCtxAttrs) String() string { return proto.CompactTextString(m) }
func (*DeleteCtxAttrs) ProtoMessage()    {}
func (*DeleteCtxAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{45, 1}
}
func (m *DeleteCtxAttrs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DeleteCtxAttrs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DeleteCtxAttrs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DeleteCtxAttrs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeleteCtxAttrs.Merge(m, src)
}
func (m *DeleteCtxAttrs) XXX_Size() int {
	return m.ProtoSize()
}
func (m *DeleteCtxAttrs) XXX_DiscardUnknown() {
	xxx_messageInfo_DeleteCtxAttrs.DiscardUnknown(m)
}

var xxx_messageInfo_DeleteCtxAttrs proto.InternalMessageInfo

func (m *DeleteCtxAttrs) GetList() []string {
	if m != nil {
		return m.List
	}
	return nil
...
type UpdateCtx struct {
	...
	Idx                  []*UpdateCtxIdList `protobuf:"bytes,2,rep,name=idx,proto3" json:"idx,omitempty"`
	Attr                 []*UpdateCtxAttrs  `protobuf:"bytes,3,rep,name=attr,proto3" json:"attr,omitempty"`
	TableDefs            []*TableDef        `protobuf:"bytes,4,rep,name=tableDefs,proto3" json:"tableDefs,omitempty"`
	HasAutoCol           []bool             `protobuf:"varint,5,rep,packed,name=has_auto_col,json=hasAutoCol,proto3" json:"has_auto_col,omitempty"`
	IdxRef               []*ObjectRef       `protobuf:"bytes,6,rep,name=idx_ref,json=idxRef,proto3" json:"idx_ref,omitempty"`
	IdxIdx               []int32            `protobuf:"varint,7,rep,packed,name=idx_idx,json=idxIdx,proto3" json:"idx_idx,omitempty"`
	IdxVal               []*UpdateCtxIdList `protobuf:"bytes,8,rep,name=idx_val,json=idxVal,proto3" json:"idx_val,omitempty"`
	IdxPk                []int32            `protobuf:"varint,9,rep,packed,name=idx_pk,json=idxPk,proto3" json:"idx_pk,omitempty"`
	OnRestrictRef        []*ObjectRef       `protobuf:"bytes,10,rep,name=on_restrict_ref,json=onRestrictRef,proto3" json:"on_restrict_ref,omitempty"`
	OnRestrictIdx        []int32            `protobuf:"varint,11,rep,packed,name=on_restrict_idx,json=onRestrictIdx,proto3" json:"on_restrict_idx,omitempty"`
	OnCascadeRef         []*ObjectRef       `protobuf:"bytes,12,rep,name=on_cascade_ref,json=onCascadeRef,proto3" json:"on_cascade_ref,omitempty"`
	OnCascadeAttrs       []*UpdateCtxAttrs  `protobuf:"bytes,13,rep,name=on_cascade_attrs,json=onCascadeAttrs,proto3" json:"on_cascade_attrs,omitempty"`
	OnCascadeIdx         []*UpdateCtxIdList `protobuf:"bytes,14,rep,name=on_cascade_idx,json=onCascadeIdx,proto3" json:"on_cascade_idx,omitempty"`
	OnSetRef             []*ObjectRef       `protobuf:"bytes,15,rep,name=on_set_ref,json=onSetRef,proto3" json:"on_set_ref,omitempty"`
	OnSetAttrs           []*UpdateCtxAttrs  `protobuf:"bytes,16,rep,name=on_set_attrs,json=onSetAttrs,proto3" json:"on_set_attrs,omitempty"`
	OnSetIdx             []*UpdateCtxIdList `protobuf:"bytes,17,rep,name=on_set_idx,json=onSetIdx,proto3" json:"on_set_idx,omitempty"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}
...
func (m *UpdateCtx) GetIdx() []*UpdateCtxIdList {
	if m != nil {
		return m.Idx
	}
	return nil
...
func (m *UpdateCtx) GetAttr() []*UpdateCtxAttrs {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (m *UpdateCtx) GetHasAutoCol() []bool {
	if m != nil {
		return m.HasAutoCol
	}
	return nil
...
func (m *UpdateCtx) GetIdxVal() []*UpdateCtxIdList {
	if m != nil {
		return m.IdxVal
	}
	return nil
...
func (m *UpdateCtx) GetIdxPk() []int32 {
	if m != nil {
		return m.IdxPk
	}
	return nil
...
func (m *UpdateCtx) GetOnCascadeAttrs() []*UpdateCtxAttrs {
	if m != nil {
		return m.OnCascadeAttrs
	}
	return nil
}

func (m *UpdateCtx) GetOnCascadeIdx() []*UpdateCtxIdList {
	if m != nil {
		return m.OnCascadeIdx
	}
	return nil
...
func (m *UpdateCtx) GetOnSetAttrs() []*UpdateCtxAttrs {
	if m != nil {
		return m.OnSetAttrs
	}
	return nil
...
func (m *UpdateCtx) GetOnSetIdx() []*UpdateCtxIdList {
	if m != nil {
		return m.OnSetIdx
	}
	return nil
...
func (m *UpdateCtxIdList) Reset()         { *m = UpdateCtxIdList{} }
func (m *UpdateCtxIdList) String() string { return proto.CompactTextString(m) }
func (*UpdateCtxIdList) ProtoMessage()    {}
func (*UpdateCtxIdList) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{46, 0}
}
func (m *UpdateCtxIdList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateCtxIdList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateCtxIdList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateCtxIdList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateCtxIdList.Merge(m, src)
}
func (m *UpdateCtxIdList) XXX_Size() int {
	return m.ProtoSize()
}
func (m *UpdateCtxIdList) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateCtxIdList.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateCtxIdList proto.InternalMessageInfo

func (m *UpdateCtxIdList) GetList() []int64 {
	if m != nil {
		return m.List
	}
	return nil
...
func (m *UpdateCtxAttrs) Reset()         { *m = UpdateCtxAttrs{} }
func (m *UpdateCtxAttrs) String() string { return proto.CompactTextString(m) }
func (*UpdateCtxAttrs) ProtoMessage()    {}
func (*UpdateCtxAttrs) Descriptor() ([]byte, []int) {
	return fileDescriptor_2d655ab2f7683c23, []int{46, 1}
}
func (m *UpdateCtxAttrs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateCtxAttrs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateCtxAttrs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateCtxAttrs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateCtxAttrs.Merge(m, src)
}
func (m *UpdateCtxAttrs) XXX_Size() int {
	return m.ProtoSize()
}
func (m *UpdateCtxAttrs) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateCtxAttrs.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateCtxAttrs proto.InternalMessageInfo

func (m *UpdateCtxAttrs) GetList() []string {
	if m != nil {
		return m.List
	}
	return nil
...
type InsertCtx struct {
	...
	Idx                  *IdList       `protobuf:"bytes,2,opt,name=idx,proto3" json:"idx,omitempty"`
	Attr                 *Attrs        `protobuf:"bytes,3,opt,name=attr,proto3" json:"attr,omitempty"`
	TableDefs            *TableDef     `protobuf:"bytes,4,opt,name=tableDefs,proto3" json:"tableDefs,omitempty"`
	HasAutoCol           bool          `protobuf:"varint,5,opt,name=has_auto_col,json=hasAutoCol,proto3" json:"has_auto_col,omitempty"`
	IdxRef               []*ObjectRef  `protobuf:"bytes,6,rep,name=idx_ref,json=idxRef,proto3" json:"idx_ref,omitempty"`
	IdxIdx               []int32       `protobuf:"varint,7,rep,packed,name=idx_idx,json=idxIdx,proto3" json:"idx_idx,omitempty"`
	IdxVal               []*IdList     `protobuf:"bytes,8,rep,name=idx_val,json=idxVal,proto3" json:"idx_val,omitempty"`
	IdxPk                []int32       `protobuf:"varint,9,rep,packed,name=idx_pk,json=idxPk,proto3" json:"idx_pk,omitempty"`
	OnRestrictRef        []*ObjectRef  `protobuf:"bytes,10,rep,name=on_restrict_ref,json=onRestrictRef,proto3" json:"on_restrict_ref,omitempty"`
	OnRestrictIdx        []int32       `protobuf:"varint,11,rep,packed,name=on_restrict_idx,json=onRestrictIdx,proto3" json:"on_restrict_idx,omitempty"`
...
func (m *InsertCtx) GetIdx() *IdList {
	if m != nil {
		return m.Idx
	}
	return nil
...
func (m *InsertCtx) GetAttr() *Attrs {
	if m != nil {
		return m.Attr
	}
	return nil
...
func (m *InsertCtx) GetTableDefs() *TableDef {
	if m != nil {
		return m.TableDefs
	}
	return nil
...
func (m *InsertCtx) GetHasAutoCol() bool {
	if m != nil {
		return m.HasAutoCol
	}
	return false
...
func (m *InsertCtx) GetIdxVal() []*IdList {
	if m != nil {
		return m.IdxVal
	}
	return nil
...
func (m *InsertCtx) GetIdxPk() []int32 {
	if m != nil {
		return m.IdxPk
	}
	return nil
...
func (m *InsertCtx) GetOnRestrictRef() []*ObjectRef {
	if m != nil {
		return m.OnRestrictRef
	}
	return nil
...
func (m *InsertCtx) GetOnRestrictIdx() []int32 {
	if m != nil {
		return m.OnRestrictIdx
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DeleteCtxIdList)(nil), "plan.DeleteCtx.idList")
	proto.RegisterType((*DeleteCtxAttrs)(nil), "plan.DeleteCtx.attrs")
	proto.RegisterType((*UpdateCtx)(nil), "plan.UpdateCtx")
	proto.RegisterType((*UpdateCtxIdList)(nil), "plan.UpdateCtx.idList")
	proto.RegisterType((*UpdateCtxAttrs)(nil), "plan.UpdateCtx.attrs")
	proto.RegisterType((*IdList)(nil), "plan.IdList")
	proto.RegisterType((*Attrs)(nil), "plan.Attrs")
...
var fileDescriptor_2d655ab2f7683c23 = []byte{
	...
	,
}
...
func (m *Node) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BindingTags) > 0 {
		dAtA55 := make([]byte, len(m.BindingTags)*10)
		var j54 int
	...
	if len(m.Children) > 0 {
		dAtA65 := make([]byte, len(m.Children)*10)
		var j64 int
		...
		i = encodeVarintPlan(dAtA, i, uint64(j64))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *DeleteCtx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ParentIds) > 0 {
		for iNdEx := len(m.ParentIds) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ParentIds[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.OnSetAttrs) > 0 {
		for iNdEx := len(m.OnSetAttrs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OnSetAttrs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.OnCascadeIdx) > 0 {
		dAtA68 := make([]byte, len(m.OnCascadeIdx)*10)
		var j67 int
	...
	if len(m.OnRestrictIdx) > 0 {
		dAtA70 := make([]byte, len(m.OnRestrictIdx)*10)
		var j69 int
	...
	if len(m.DelIdxIdx) > 0 {
		dAtA72 := make([]byte, len(m.DelIdxIdx)*10)
		var j71 int
		for _, num1 := range m.DelIdxIdx {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.DelIdxRef) > 0 {
		for iNdEx := len(m.DelIdxRef) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DelIdxRef[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *DeleteCtxIdList) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DeleteCtxIdList) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DeleteCtxIdList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.List) > 0 {
		dAtA74 := make([]byte, len(m.List)*10)
		var j73 int
...
func (m *DeleteCtxAttrs) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DeleteCtxAttrs) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DeleteCtxAttrs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.List) > 0 {
		for iNdEx := len(m.List) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPlan(dAtA, i, uint64(len(m.List[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *UpdateCtx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnCascadeAttrs) > 0 {
		for iNdEx := len(m.OnCascadeAttrs) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OnCascadeAttrs[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.OnRestrictIdx) > 0 {
		dAtA76 := make([]byte, len(m.OnRestrictIdx)*10)
		var j75 int
		for _, num1 := range m.OnRestrictIdx {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.IdxPk) > 0 {
		dAtA78 := make([]byte, len(m.IdxPk)*10)
		var j77 int
		for _, num1 := range m.IdxPk {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.IdxVal) > 0 {
		for iNdEx := len(m.IdxVal) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.IdxVal[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.IdxIdx) > 0 {
		dAtA80 := make([]byte, len(m.IdxIdx)*10)
		var j79 int
	...
	if len(m.HasAutoCol) > 0 {
		for iNdEx := len(m.HasAutoCol) - 1; iNdEx >= 0; iNdEx-- {
			i--
			if m.HasAutoCol[iNdEx] {
				dAtA[i] = 1
			} else {
				dAtA[i] = 0
			}
		}
		i = encodeVarintPlan(dAtA, i, uint64(len(m.HasAutoCol)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *UpdateCtxIdList) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateCtxIdList) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateCtxIdList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.List) > 0 {
		dAtA82 := make([]byte, len(m.List)*10)
		var j81 int
		for _, num1 := range m.List {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *UpdateCtxAttrs) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateCtxAttrs) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateCtxAttrs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *IdList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.List) > 0 {
		dAtA84 := make([]byte, len(m.List)*10)
		var j83 int
		for _, num1 := range m.List {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *Attrs) Marshal() (dAtA []byte, err error) {
	size := m.ProtoSize()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Attrs) MarshalTo(dAtA []byte) (int, error) {
	size := m.ProtoSize()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Attrs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *InsertCtx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnRestrictIdx) > 0 {
		dAtA87 := make([]byte, len(m.OnRestrictIdx)*10)
		var j86 int
		for _, num1 := range m.OnRestrictIdx {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintPlan(dAtA, i, uint64(j86))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.OnRestrictRef) > 0 {
	...
	if len(m.IdxPk) > 0 {
		dAtA89 := make([]byte, len(m.IdxPk)*10)
		var j88 int
		for _, num1 := range m.IdxPk {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintPlan(dAtA, i, uint64(j88))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.IdxVal) > 0 {
	...
	if len(m.IdxIdx) > 0 {
		dAtA91 := make([]byte, len(m.IdxIdx)*10)
		var j90 int
		for _, num1 := range m.IdxIdx {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if m.TableDefs != nil {
		{
			size, err := m.TableDefs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DropTable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForeignTbl) > 0 {
		dAtA132 := make([]byte, len(m.ForeignTbl)*10)
		var j131 int
		...
		i = encodeVarintPlan(dAtA, i, uint64(j131))
		i--
		dAtA[i] = 0x3a
	}
	if m.TableId != 0 {
...
func (m *TruncateTable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ForeignTbl) > 0 {
		dAtA136 := make([]byte, len(m.ForeignTbl)*10)
		var j135 int
		for _, num := range m.ForeignTbl {
			for num >= 1<<7 {
...
func (m *ClusterTable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AccountIDs) > 0 {
		dAtA139 := make([]byte, len(m.AccountIDs)*10)
		var j138 int
		...
		i = encodeVarintPlan(dAtA, i, uint64(j138))
		i--
		dAtA[i] = 0x12
	}
	if m.IsClusterTable {
...
func (m *Prepare) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ParamTypes) > 0 {
		dAtA143 := make([]byte, len(m.ParamTypes)*10)
		var j142 int
...
func (m *DeleteCtxIdList) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DeleteCtxAttrs) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateCtx) ProtoSize() (n int) {
	...
	if len(m.HasAutoCol) > 0 {
		n += 1 + sovPlan(uint64(len(m.HasAutoCol))) + len(m.HasAutoCol)*1
	}
	if len(m.IdxRef) > 0 {
	...
	if len(m.OnCascadeAttrs) > 0 {
		for _, e := range m.OnCascadeAttrs {
			l = e.ProtoSize()
			n += 1 + l + sovPlan(uint64(l))
		}
	}
...
func (m *UpdateCtxIdList) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateCtxAttrs) ProtoSize() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DeleteCtx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DelRef = append(m.DelRef, &ObjectRef{})
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelIdxRef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DelIdxRef = append(m.DelIdxRef, &ObjectRef{})
			if err := m.DelIdxRef[len(m.DelIdxRef)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType == 0 {
				...
				m.DelIdxIdx = append(m.DelIdxIdx, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.DelIdxIdx) == 0 {
					m.DelIdxIdx = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field DelIdxIdx", wireType)
			}
		case 4:
			if wireType != 2 {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnSetAttrs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnSetAttrs = append(m.OnSetAttrs, &DeleteCtxAttrs{})
			if err := m.OnSetAttrs[len(m.OnSetAttrs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			...
			m.OnSetIdx = append(m.OnSetIdx, &DeleteCtxIdList{})
		...
		case 12:
			...
			m.ParentIds = append(m.ParentIds, &DeleteCtxIdList{})
			if err := m.ParentIds[len(m.ParentIds)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DeleteCtxIdList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *DeleteCtxAttrs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: attrs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: attrs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UpdateCtx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Idx = append(m.Idx, &UpdateCtxIdList{})
		...
		case 3:
			...
			m.Attr = append(m.Attr, &UpdateCtxAttrs{})
		...
		case 5:
			if wireType == 0 {
				...
				m.HasAutoCol = append(m.HasAutoCol, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				var elementCount int
				elementCount = packedLen
				if elementCount != 0 && len(m.HasAutoCol) == 0 {
					m.HasAutoCol = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IdxVal", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IdxVal = append(m.IdxVal, &UpdateCtxIdList{})
			if err := m.IdxVal[len(m.IdxVal)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.IdxPk) == 0 {
					m.IdxPk = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field IdxPk", wireType)
			}
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnRestrictRef", wireType)
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnCascadeAttrs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnCascadeAttrs = append(m.OnCascadeAttrs, &UpdateCtxAttrs{})
			if err := m.OnCascadeAttrs[len(m.OnCascadeAttrs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 14:
			...
			m.OnCascadeIdx = append(m.OnCascadeIdx, &UpdateCtxIdList{})
		...
		case 16:
			...
			m.OnSetAttrs = append(m.OnSetAttrs, &UpdateCtxAttrs{})
			if err := m.OnSetAttrs[len(m.OnSetAttrs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 17:
			...
			m.OnSetIdx = append(m.OnSetIdx, &UpdateCtxIdList{})
			if err := m.OnSetIdx[len(m.OnSetIdx)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *UpdateCtxIdList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *UpdateCtxAttrs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Attrs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *InsertCtx) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.TableDefs == nil {
				m.TableDefs = &TableDef{}
			}
			if err := m.TableDefs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
		...
		case 8:
			...
			m.IdxVal = append(m.IdxVal, &IdList{})
			if err := m.IdxVal[len(m.IdxVal)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
